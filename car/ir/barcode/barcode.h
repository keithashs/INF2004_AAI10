...
// ===== Thresholds =====
#define BARCODE_BLACK_THRESHOLD   1800   // ADC > 1800 = black bar
#define BARCODE_WHITE_THRESHOLD   1200   // ADC < 1200 = white space

// ===== Timing Constants (adjusted for variable speed) =====
#define MIN_BAR_WIDTH_US      300      // Minimum bar width (microseconds)
#define MAX_BAR_WIDTH_US      15000    // Maximum valid width
#define PATTERN_TIMEOUT_US    20000    // Pattern must complete within this time
#define MAX_BARS              50       // Maximum bars to capture (Code 39 needs ~29)
#define NOISE_FILTER_US       200      // Ignore transitions shorter than this
...
typedef struct {
    ...
    char decoded_char;    // Actual decoded character (for debug)
} barcode_result_t;
...
// Returns true if new barcode detected and decoded
...
// Set speed calibration factor (call when speed changes)
// factor = current_speed / nominal_speed
